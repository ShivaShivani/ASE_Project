...
MongoClient mongoClient;
	...
	private DBCollection getDBCollection(){
		...
		//Gettoing object to database created in the mongodb. Here I have created a database named as "mydb"
	...
	public boolean sendDataToMongoDB(BasicDBObject basicObject) {
		...
		BasicDBObject basicDBObject = new BasicDBObject("username", basicObject.get("user_name"));
